              ...
              <Card key={cabana.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                <CardHeader className="p-0">
                  <div className="relative h-64 overflow-hidden">
                    <img
                      src={cabana.fotografias[0] || "/placeholder.svg"} // <-- usa la primera foto o placeholder
                      alt={cabana.nombre}
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium">{cabana.capacidad_maxima} personas</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <DollarSign className="h-5 w-5 text-primary" />
                      <span className="text-sm font-medium">${cabana.precio_por_noche}/noche</span>
                    </div>
                  </div>
